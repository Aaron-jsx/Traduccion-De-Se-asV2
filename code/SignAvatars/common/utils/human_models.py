...
human_model_path = osp.join(osp.dirname(__file__), '..', '..', '..', '..', 'models', 'human_model_files')
class SMPLX(object):
    def __init__(self):
        ...
        # body v1
        # 55,12,16,17,18,19,0,  # Nose, Neck, L_Shoulder, R_Shoulder, L_Elbow, R_Elbow, Pelvis
        # 55,16,17,18,19,0,  # Nose, L_Shoulder, R_Shoulder, L_Elbow, R_Elbow, Pelvis

        # body v2: including face
        #55,57,56,59,58,16,17,18,19,0, # Nose, L_eye, R_eye, L_ear, R_ear, L_Shoulder, R_Shoulder, L_Elbow, R_Elbow, Pelvis
        55,57,56,59,58,16,17,18,19,0,1,2,12,3,6,9, # 13,14,# Nose, L_eye, R_eye, L_ear, R_ear, L_Shoulder, R_Shoulder, L_Elbow, R_Elbow, pelvis, l_hip, r_hip, Neck, spine

        # legs
        4,5,7,8, 60,61,62,63,64,65,
        ...
        # hand
        20,37,38,39,66,25,26,27,67,28,29,30,68,34,35,36,69,31,32,33,70, # left hand joints, 20
        21,52,53,54,71,40,41,42,72,43,44,45,73,49,50,51,74,46,47,48,75 # right hand joints, 20
        )

        # self.joint_idx = \
        # (0,1,2,4,5,7,8,12,16,17,18,19,20,21,60,61,62,63,64,65,59,58,57,56,55, # body joints, 25
        # 37,38,39,66,25,26,27,67,28,29,30,68,34,35,36,69,31,32,33,70, # left hand joints, 20
        # 52,53,54,71,40,41,42,72,43,44,45,73,49,50,51,74,46,47,48,75, # right hand joints, 20
        # 22,15, # jaw, head
        # 57,56, # eyeballs
